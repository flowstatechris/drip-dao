...
const App = () => {
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to DripDAO</h1>
        <p>the bridge between blockchain and fashion</p>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Access all governance privleges here!</p>
        <div>
          <div>
            <h2>Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free DripDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
      ...
      <tr>
     <td>
       <a href={"https://faucets.chain.link/rinkeby"}><h4>need testnet funds? click here</h4></a>
       </td>
    </tr>
    </div>
  );
